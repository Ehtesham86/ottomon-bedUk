...
// setPId(parts[1])
const response = await axios.get(`https://ottomonbackend-l-f8a1.vercel.app/accessories/${params.slug}`);
console.log('Fetched data:', response.data.accessories.price);
  ...
  //   const fetchsales = async () => {
  //     try {
  //       const response = await axios.get("https://ottomonbackend-l-f8a1.vercel.app/sales/id");
  //       setLoading(false);
